                        ...
                        <form method="POST" action="{{ route('blogs.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" required type="text" name="author" value="{{ $blog->author }}">
                                            @error('author')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" value="{{ $blog->date }}" name="date" max="{{ Carbon\Carbon::now()->format('Y-m-d') }}" class="form-control">
                                            @error('date')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img class="rounded avatar-lg" id="showImage" src="{{  asset($blog->image) }}" alt="Blog image">
