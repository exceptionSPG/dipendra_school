                        ...
                        <form method="POST" action="{{ route('events.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" required type="text" name="location" value="{{ $event->location }}">
                                            @error('location')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" value="{{ $event->date }}" name="date" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" class="form-control">
                                            @error('date')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input type="text" value="{{ $event->time }}" required class="form-control datetimepicker" name="time">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img class="rounded avatar-lg" id="showImage" src="{{  asset($event->thumbnail) }}" alt="Member image">


                                </div>
                            </div>
                            <!-- end row -->
                            <input type="submit" value="Update Event Data" class="btn btn-info waves-effect waves-light">
                        </form>
