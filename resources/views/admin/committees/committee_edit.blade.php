            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Edit {{$committee->name}} Details</h4><br><br>
                        <form method="POST" action="{{ route('committee.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img class="rounded avatar-lg" id="showImage" src="{{ (!empty($committee->thumbnail))? url($committee->thumbnail):url('upload/no_image.png') }}" alt="Card image cap">


                                </div>
                            </div>
                            <!-- end row -->
                            <input type="submit" value="Update Details" class="btn btn-info waves-effect waves-light">
                        </form>
