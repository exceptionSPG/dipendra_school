            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('bhupu_bidhyarthi.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" required type="text" name="name" placeholder="Raju GC">
                                            @error('name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" required type="text" name="phone" placeholder="98********">
                                            @error('phone')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" required type="text" name="address" placeholder="Gorahi,Dang">
                                            @error('address')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" required type="text" name="profession" placeholder="Farmer">
                                            @error('profession')
                                            <span class="text-danger"> {{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" required type="file" id="slide_image" name="photo" accept="image/png, image/jpeg">
