...
@section('title')
भूपू बिद्यार्थी संघ - Dipendra Higher Secondary School
@endsection
@section('content')
...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <img class="img-fluid w-100 mb-4" width="1110" height="589" src="{{ asset($bhupu->thumbnail) }}" alt="about image">
                <h2 class="section-title">{{$bhupu->name}} </h2>
                {!!$bhupu->about !!}
            </div>
        </div>
    </div>
